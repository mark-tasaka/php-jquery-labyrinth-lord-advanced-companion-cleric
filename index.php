		...
		<form action="" id ="clericForm"  target="_blank" method="post">
            ...
            <br/>
			  ...
			  <select id="chracterRace" name="theCharacterRace" class="alignmentBox">	
                ...
                <option value="Dwarf">Dwarf (8)*</option>
				<option value="Elf">Elf (7)*</option>
				<option value="Gnome">Gnome (7)*</option>
				<!--<option value="Halfling">Halfling (6)*</option>-->
				<option value="Half-Elf">Half-Elf (5)*</option>
				<option value="Half-Orc">Half-Orc (4)*</option>
			  </select>
                
               <p><span class="footnote2">&#42;Maximum demi-human cleric level.</span></p>
            ...
            <br/>
			  ...
			  <select id="hitDice" name="theHitDice" class="alignmentBox">	
				<option value="1" selected>d6, standard HD</option>
				<option value="2">d8, advanced HD (optional)</option>
			  </select>
			...
			<div class="generatorButtonA2">
                ...
                <script>
                    ...
                    $("#generate_characters2").click(function(){
                        ...
                        $("#clericForm").attr('action', "character/ll_cleric_"+ $("#abilityScores").val() +  ".php");
