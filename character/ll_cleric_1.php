...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
    ...
    <script type="text/javascript" src="./js/clericAbilities.js"></script>
  ...
  <img id="character_sheet"/>
   <section>
      ...
      <span id="primeReq"></span>
       ...
       <span id="clericSpecial"></span>
       
       <span id="spellsLevel1"></span>
       <span id="spellsLevel2"></span>
       <span id="spellsLevel3"></span>
       <span id="spellsLevel4"></span>
       <span id="spellsLevel5"></span>
       <span id="spellsLevel6"></span>
       <span id="spellsLevel7"></span>
  ...
  <script>
	...
	*/
	function Character() {
        ...
        let	wisdomBase = rollDice(6, 3, 1, 6);
		...
		let clericCharacter = {
            ...
            "level1Spells": <?php echo $spellsLevel1 ?> + bonusSpellsLevel1 (wisdom),
            "level2Spells": <?php echo $spellsLevel2 ?> + bonusSpellsLevel2 (wisdom, <?php echo $level ?>),
            ...
            "clericWisdomBonus": wisdomBonusCleric (wisdom),
            "clericMessage": clericAbilities (<?php echo $level ?>),
      ...
      $("#wisdomTable").html(data.clericWisdomBonus);
      $("#clericSpecial").html(data.clericMessage);
      ...
      $("#spellsLevel5").html(data.level5Spells);
      $("#spellsLevel6").html(data.level6Spells);
      $("#spellsLevel7").html(data.level7Spells);
